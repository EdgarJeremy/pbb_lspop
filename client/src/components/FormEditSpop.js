...
export default class FormEditSpop extends React.Component {
    ...
    onSubmit() {
        ...
        spop_data.file_ktp = (/unchanged_/.test(spop_data.file_ktp)) ? undefined : spop_data.file_ktp;
        spop_data.file_bukti_kepemilikan = (/unchanged_/.test(spop_data.file_bukti_kepemilikan)) ? undefined : spop_data.file_bukti_kepemilikan;
        spop_data.file_izin_mendirikan_bangunan = (/unchanged_/.test(spop_data.file_izin_mendirikan_bangunan)) ? undefined : spop_data.file_izin_mendirikan_bangunan;
        spop_data.file_surat_keterangan_kelurahan = (/unchanged_/.test(spop_data.file_surat_keterangan_kelurahan)) ? undefined : spop_data.file_surat_keterangan_kelurahan;
        ...
        AdminApi.edit_data_spop(spop_data, (complete) => {
    ...
    componentDidMount() {
        ...
        const file_object = {};
        file_object.file_ktp = this.props.form_data.file_ktp;
        file_object.file_bukti_kepemilikan = this.props.form_data.file_bukti_kepemilikan;
        file_object.file_izin_mendirikan_bangunan = this.props.form_data.file_izin_mendirikan_bangunan;
        file_object.file_surat_keterangan_kelurahan = this.props.form_data.file_surat_keterangan_kelurahan;

        AdminApi.base64(file_object).then((response) => {
            if (response.status) {
                const state = this.state;

                for (let i = 0; i < response.data.length; i++) {
                    let which = response.data[i].file;
                    let data = response.data[i].data;
                    let mime = data.split(",")[0].split(";")[0].split(":")[1];
                    let blob = new Blob([window.atob(data.split(",")[1])], { type: mime });
                    blob.lastModifiedDate = new Date();
                    blob.name = Math.random();
                    this.props.form_data[which] = `unchanged_${which}`;
                    state[`display_${which}`] = data;
                }
                this.props.form_data.file_izin_mendirikan_bangunan = (this.props.form_data.file_izin_mendirikan_bangunan === "null") ? null : this.props.form_data.file_izin_mendirikan_bangunan;
                this.setState({
                    ...state,
                                        ...
                                        <div className="file-box">
                                            <Card style={{ width: "300px" }}>
                                                ...
                                                <CardActions>
                                                    <FlatButton onClick={() => {
                                                            let media;
                                                            if(this.state.display_file_ktp.split(";")[0].split(":")[1].split("/")[0] === "image") {
                                                                media = new Image();
                                                            ...
                                                            media.src = this.state.display_file_ktp;
                                                            let w = window.open("");
                                                            w.document.write(media.outerHTML);
                                                        }
                                                    } label="Ukuran Penuh" />
                                        ...
                                        <div className="file-box">
                                            <Card style={{ width: "300px" }}>
                                                ...
                                                <CardActions>
                                                    <FlatButton onClick={() => {
                                                            let media;
                                                            if(this.state.display_file_bukti_kepemilikan.split(";")[0].split(":")[1].split("/")[0] === "image") {
                                                                media = new Image();
                                                                media.style = "width: 100%";
                                                            } else {
                                                                media = document.createElement("iframe");
                                                            ...
                                                            media.src = this.state.display_file_bukti_kepemilikan;
                                                            let w = window.open("");
                                                            w.document.write(media.outerHTML);
                                                        }
                                                    } label="Ukuran Penuh" />
                                        ...
                                        <div className="file-box">
                                            <Card style={{ width: "300px" }}>
                                                ...
                                                <CardActions>
                                                    <FlatButton onClick={() => {
                                                            let media;
                                                            if(this.state.display_file_surat_keterangan_kelurahan.split(";")[0].split(":")[1].split("/")[0] === "image") {
                                                                media = new Image();
                                                                media.style = "width: 100%";
                                                            } else {
                                                                media = document.createElement("iframe");
                                                            ...
                                                            media.src = this.state.display_file_surat_keterangan_kelurahan;
                                                            let w = window.open("");
                                                            w.document.write(media.outerHTML);
                                                        }
                                                    } label="Ukuran Penuh" />
                                        ...
                                        <div className="file-box">
                                            <Card style={{ width: "300px" }}>
                                                ...
                                                <CardActions>
                                                    <FlatButton onClick={() => {
                                                            let media;
                                                            if(this.state.display_file_izin_mendirikan_bangunan.split(";")[0].split(":")[1].split("/")[0] === "image") {
                                                                media = new Image();
                                                                media.style = "width: 100%";
                                                            } else {
                                                                media = document.createElement("iframe");
                                                            ...
                                                            media.src = this.state.display_file_izin_mendirikan_bangunan;
                                                            let w = window.open("");
                                                            w.document.write(media.outerHTML);
                                                        }
                                                    } label="Ukuran Penuh" />
